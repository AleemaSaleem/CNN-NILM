...
DATA_DIRECTORY = 'D:/FYDP/transferNILM-master/data/REDD/'
SAVE_PATH = 'D:/FYDP/transferNILM-master/train_data/redd_train/microwave/'
AGG_MEAN = 522
AGG_STD = 814
def get_arguments():
    ...
    parser.add_argument('--appliance_name', type=str, default='microwave',
                          help='which appliance you want to train: microwave,\
