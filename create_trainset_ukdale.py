...
DATA_DIRECTORY = 'D:/FYDP/transferNILM-master/data/ukdale/'
SAVE_PATH = 'D:/FYDP/transferNILM-master/train_data/uk_train/washingmachine/'
AGG_MEAN = 522
AGG_STD = 814
...
def get_arguments():
    ...
    parser.add_argument('--appliance_name', type=str, default='washingmachine',
                          ...
                          fridge,kettle,microwave,dishwasher')
