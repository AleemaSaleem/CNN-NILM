...
def get_model(appliance, input_tensor, window_length, transfer_dense=False, transfer_cnn=False,n_dense = 1,
              cnn='kettle',  pretrainedmodel_dir='D:/FYDP/transferNILM-master/model/'):
    ...
    model = keras.model(inputs=input_tensor, outputs=d_out)
